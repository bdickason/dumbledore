...
describe('Xmas Event', function() {
	beforeEach(function() {
		...
		getHouseStub = this.sinon.stub(User, 'getHouse');

		// Stub out random number generator
		random = {
			between: function() {}
		}
		randomStub = this.sinon.stub(random, 'between');

		Xmas = require('.');
		Xmas.start(eventbus, Team, User, 10, 10);
	});
	describe('!xmas', function() {
		it('Happy path test', function(done) {
			var _response = [];
