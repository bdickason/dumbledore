...
describe('Random', function() {
	describe('Dice', function() {
		it('Contains settings for !dice trigger', function() {
			assert.notEqual(Random.commands, null);
			assert.equal(Random.commands[1].name, 'dice');
			assert.equal(Random.commands[1].type, 'chat');
			assert.equal(Random.commands[1].whitelist, null);
			assert.equal(Random.commands[1].event, 'random:dice');
		});
	...
	describe('Coin', function() {
		it('Contains settings for !coin', function() {
			assert.notEqual(Random.commands, null);
			assert.equal(Random.commands[0].name, 'coin');
			assert.equal(Random.commands[0].type, 'chat');
			assert.equal(Random.commands[0].whitelist, null);
			assert.equal(Random.commands[0].event, 'random:coin');
		});
